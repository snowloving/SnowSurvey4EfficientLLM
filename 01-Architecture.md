<p align="center">
  <img src="https://img.shields.io/badge/Papers-39-blue?style=flat-square" alt="Paper Count">
...
|![Publish](https://img.shields.io/badge/Paper-arXiv'21-b31b1b) <br>[M6-T: Exploring Sparse Expert Models and Beyond](https://arxiv.org/abs/2105.15082) <br> An Yang, Junyang Lin, Rui Men, Chang Zhou, Le Jiang, Xianyan Jia, Ang Wang, Jie Zhang, Jiamang Wang, Yong Li, et al. | |[Paper](https://arxiv.org/pdf/2105.15082)|
...
|![Publish](https://img.shields.io/badge/Paper-arXiv'24-b31b1b) <br>[Griffin: Mixing Gated Linear Recurrences with Local Attention for Efficient Language Models](https://arxiv.org/abs/2402.19427) <br> Soham De, Samuel L. Smith, Anushan Fernando, Aleksandar Botev, George Cristian-Muraru, Albert Gu, Ruba Haroun, Leonard Berrada, Yutian Chen, Srivatsan Srinivasan, et al. | |[Paper](https://arxiv.org/pdf/2402.19427)|
|![Publish](https://img.shields.io/badge/Paper-arXiv'23-b31b1b) <br>[Retentive Network: A Successor to Transformer for Large Language Models](https://arxiv.org/abs/2307.08621) <br> Yutao Sun, Li Dong, Shaohan Huang, Shuming Ma, Yuqing Xia, Jilong Xue, Jianyong Wang, Furu Wei | |[Paper](https://arxiv.org/pdf/2307.08621)|
